...
docker exec --privileged -ti $DOCKER_CONTAINER_ID /bin/bash -xec \
    "mkdir PNG; cd PNG; wget https://github.com/glennrp/libpng/archive/v1.6.37.tar.gz; gzip -cd v1.6.37.tar.gz | tar xvf -; cd libpng-1.6.37/; ./configure --prefix=/usr; make -j2; make install; ldconfig; cd ../../"
